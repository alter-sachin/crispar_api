...
module.exports = function(app){
	...
	app.route('/api/restaurant/:userId/orders').get(controller.getOrdersOfRestaurant);
	app.route('/api/restaurant/:userId/tables').get(controller.getTablesOfRestaurant);
